...
/**
 * WCAG-compliant high contrast toggle button
 * - Uses CSS custom properties instead of CSS filters
...
export default function ContrastToggle({
  ...
  return (
    <button
      ...
      title={isHighContrast ? 'Wyłącz wysoki kontrast' : 'Włącz wysoki kontrast'}
    >
      <svg
        width={28 * scale}
        height={28 * scale}
